...
Use [Edge Scaffold](/docs/studio/scaffold) as the reference implementation for this flow.
...
- [Device mesh](/docs/edge-kit/device-mesh) — Transfer artifacts between trusted user-owned devices.
- [Architecture](/docs/concepts/architecture) — Product boundaries and data ownership.
- [Neural Imprint vs LoRA](/docs/concepts/neural-imprint-vs-lora) — Deployment tradeoffs versus weight adaptation and prompt stuffing.
