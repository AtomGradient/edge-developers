...
A quick reference for every route in the Edge Studio web interface. For the main workflow, see [Studio overview](/docs/optimize-and-ship/studio-overview) and [Optimize and benchmark](/docs/optimize-and-ship/optimize-and-benchmark).
