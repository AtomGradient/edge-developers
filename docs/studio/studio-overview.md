...
[Install Edge Studio](/docs/quickstart/install#launch-the-web-ui).
...
- [Optimize and benchmark](/docs/studio/optimize-and-benchmark)
- [Export models](/docs/studio/export)
