...
- [Build the Agent carrier](/docs/quickstart/build-agent-carrier) — End-to-end walkthrough from Edge Studio export to real-device validation.
- [Platform requirements](/docs/reference/platform-requirements) — Device and OS constraints.
