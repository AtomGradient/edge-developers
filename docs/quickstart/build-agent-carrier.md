...
[Build your first device Agent](/docs/quickstart/first-agent).
...
- Run the [device Agent demo](/docs/quickstart/first-agent) if you have not
  already compared before/after answers.
- Read [Edge Scaffold configuration](/docs/studio/scaffold) for the
  template fields Edge Studio rewrites during export.
- Review [Neural Imprint vs LoRA](/docs/concepts/neural-imprint-vs-lora) when
