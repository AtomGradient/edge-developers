...
- Planned demo CLI commands are not shipped in current preview: `edge models fetch`, `edge demo imprint run`, and `edge demo receipt` are tracked by B2/B4/B6 in the Developer Preview DX roadmap.
