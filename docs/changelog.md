...
During Developer Preview, Swift package releases follow `1.0.0-rcN` tags. Edge Studio's Python package currently uses PyPI version `0.0.1rc8` and GitHub tag `v0.0.1rc8`. Breaking changes are documented here with migration steps. After general availability, we will follow semantic versioning.
...
|---|---|---|
| Edge Studio | Python package `edge-studio==0.0.1rc8`, GitHub tag `v0.0.1rc8` | Installs the single `edge` command. Launch the local Studio UI with `edge studio`. |
