...
After the base chat works, continue to [Build your first device Agent](/docs/get-started/minute-demo) to inspect the synthetic finance signal and see user-specific learning restored without creating a new model release. Then export the same lifecycle into an [Agent carrier](/docs/examples/build-and-ship).
