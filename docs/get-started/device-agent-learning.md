...
The `.xcodeproj` is already generated by the export; the app source lives in the nested `FinanceAgent/` subfolder. (If you later edit `project.yml`, regenerate with `xcodegen generate`.) In Xcode:
