...
[the 5-minute demo](/docs/get-started/minute-demo) for the manifest-based path that
...
`--tools-manifest` (see the [5-minute demo](/docs/get-started/minute-demo)) remains
