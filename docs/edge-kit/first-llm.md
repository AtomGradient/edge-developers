...
| Task | Guide |
| --- | --- |
| Text generation | [LLM guide](/docs/edge-kit/text-generation) |
| Vision-language inference | [VLM guide](/docs/edge-kit/vision) |
| Model cache and downloads | [Model management](/docs/reference/model-management) |
| iOS memory guidance | [Memory management](/docs/reference/memory-management) |
| Platform support | [Platform requirements](/docs/reference/platform-requirements) |
