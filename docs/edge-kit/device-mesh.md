...
- [Model evolution](/docs/concepts/model-evolution) — Transfer Neural Imprint artifacts across trusted devices.
- [Architecture](/docs/concepts/architecture) — How all the layers connect.
