...
After the shell builds, continue to [Build the Agent carrier](/docs/quickstart/build-agent-carrier). That guide adds the finance scenario, Edge Studio export flow, model configuration, Neural Imprint restore checks, and real-device validation.
