...
In `edge-kit@1.0.0-rc98`, `WhisperEngine` is a skeleton for future whisper.cpp xcframework integration. It does not perform real transcription. Use `STTEngine` from `EdgeInference` for runnable native ASR examples in the current preview.
:::
