...
参考实现见 [Edge Scaffold](/docs/studio/scaffold)。
...
- [设备 Mesh](/docs/edge-kit/device-mesh) — 在受信任的用户自有设备之间传输 artifacts。
- [架构](/docs/concepts/architecture) — 产品边界与数据归属。
- [Neural Imprint vs LoRA](/docs/concepts/neural-imprint-vs-lora) — 与 weight adaptation 和 prompt stuffing 的部署取舍。
