...
| 任务 | 指南 |
| --- | --- |
| 文本生成 | [LLM 指南](/docs/edge-kit/text-generation) |
| 视觉语言推理 | [VLM 指南](/docs/edge-kit/vision) |
| 模型缓存与下载 | [模型管理](/docs/reference/model-management) |
| iOS 内存指南 | [内存管理](/docs/reference/memory-management) |
| 平台支持 | [平台要求](/docs/reference/platform-requirements) |
