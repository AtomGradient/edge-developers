...
| 路径 | 你证明了什么 |
|------|-------------|
| [CLI demo](/docs/quickstart/first-agent) | 学习机制有效 |
...
| 目标 | 去哪里 |
|------|--------|
| 了解 NI 和 LoRA/SFT 的区别 | [Neural Imprint vs LoRA](/docs/concepts/neural-imprint-vs-lora) |
| 了解产品架构 | [Architecture](/docs/concepts/architecture) |
| 定制你的 Agent 载体 | [Edge Scaffold](/docs/studio/scaffold) |
